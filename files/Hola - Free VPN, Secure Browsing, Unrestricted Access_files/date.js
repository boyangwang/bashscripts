...
E.init = function(){
    ...
    {
        var monotonic_last, monotonic_adjust;
        E.monotonic = function(){
            var now = Date.now()+E.monotonic_adjust;
            if (now>=E.monotonic_last)
                return (E.monotonic_last = now);
            E.monotonic_adjust += E.monotonic_last-now;
            return E.monotonic_last;
        };
        E.monotonic_reset = function(){
            E.monotonic_last = E.monotonic_adjust = 0; };
    }
    E.monotonic_reset();
};
E.init();
